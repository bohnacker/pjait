...
document.addEventListener("DOMContentLoaded", function() {
    this.addEventListener('click', getRGB);
});
...
function specialEllipse(x, y, w, h) {
	strokeWeight(1);    
	//fill(r, g, b,100);
	var w = sin(frameCount * random() / 30 + random(100)) * 5 + 5;
	ellipse(x, y, w, w);

	strokeWeight(1)
    stroke(r,g,b,100);
	//fill(r, g, b,200);
	w = sin(frameCount * random() / 20 + random(100)) * 6 + 6;
	ellipse(x, y, w, w);
    
    strokeWeight(1)
    stroke(r,g,b,100);
	//fill(r, g, b,200);
	w = sin(frameCount * random() / 30 + random(100)) * 7 + 7;
	ellipse(x, y, w, w);
    
    strokeWeight(1)
    stroke(r,g,b,100);
	//fill(r, g, b,200);
	w = sin(frameCount * random() / 20+ random(100)) * 10 + 20;
	ellipse(x, y, w, w);
    
    strokeWeight(1)
    stroke(r,g,b,);
	//fill(r, g, b,200);
	w = sin(frameCount * random() / 10 + random(100)) * 10 + 30;
	ellipse(x, y, w, w);
